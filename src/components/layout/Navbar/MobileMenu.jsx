      ...
      >
        ...
        <div className="relative h-screen flex flex-col px-[6%] md:px-[8%]">
          ...
          <div className="flex-1 overflow-y-auto py-8">
                    ...
                    ? (
                      <div className="relative w-full">
                        ...
                        >
                          ...
                          <ChevronDown size={20} className={`transition-transform duration-500 ${activeMenu === index ? "rotate-180 text-coffee" : "text-gray-500"}`} />
                        </button>
                      </div>
                    ) : (
                      <NavLink
                        ...
                        className={({ isActive }) => `
                          ...
                          ${isActive ? "text-coffee" : "text-gray-400 hover:text-white hover:translate-x-2"}
                        `}
                      >
                        {item.name}
                      </NavLink>
            ...
            <hr className="my-8 border-gray-50/10" />

            <ul className="flex items-center gap-4 px-4 py-4">
              {[
                { Icon: Facebook, color: "from-blue-600 to-blue-400" },
                { Icon: Instagram, color: "from-coffee via-[#B19777] to-coffee" },
          ...
          {/* Fixed Footer */}
          <div className="py-6 border-t border-gray-50/10 shrink-0">
